    ...
    public class BokningDbContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            optionsBuilder
                ...
                .UseSqlServer(@"Server=(localdb)\mssqllocaldb;Database=Grupp24Ny;Integrated Security=True;MultipleActiveResultSets=true;");
        ...
        public void Reset()
        {
            ...
            using (SqlConnection conn = new SqlConnection(@"Server=(localdb)\mssqllocaldb;Database=Grupp24Ny;Integrated Security=True;MultipleActiveResultSets=true;"))
